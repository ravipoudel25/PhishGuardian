...
class FeatureExtraction:
    ...
    def shortUrl(self):
        match = re.search('''bit\\.ly|goo\\.gl|shorte\\.st|go2l\\.ink|
                          ...
                          v\\.gd|tr\\.im|link\\.zip\\.net|http\:\/\/web\.''', self.url)
        if match:
            return -1
        return 1
    ...
    def SubDomains(self):
        ...
        pattern = re.findall("www\d+|www\.\d|www\.[0-9]+\.[a-zA-Z]+|www\.[a-zA-Z]*[0-9]+[a-zA-Z]*\.[a-zA-Z]+", self.url)
        if bool(pattern):
            return -1
        if dot_count == 1:
            return 1
    ...
    def Hppts(self):
        try:
            pattern = re.findall("https:\/\/[a-zA-Z]*[0-9]+[a-zA-Z]*", self.url)
            if bool(pattern):
                return -1
    ...
    def LinksPointingToPage(self):
        try:
            if self.response.text is None:
                return -1
            number_of_links = len(re.findall(r"<a\s+href=", self.response.text))
